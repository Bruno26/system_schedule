...
// $this->performAjaxValidation($model);
        if (isset($_POST['Seccion'])) {
            $consulta = Seccion::model()->findByAttributes(array(
                'fk_carrera' => (int) $_POST['Seccion']['fk_carrera'],
                'fk_trayecto' => (int) $_POST['Seccion']['fk_trayecto'],
                'fk_trimestre' => (int) $_POST['Seccion']['fk_trimestre'],
                'es_activo' => 1,
...
// we only allow deletion via POST request
            Seccion::model()->UpdateByPk($id,array("es_activo"=>0));
